...
export function FireSaleBanner() {
  return (
    <div className="group relative -mx-4 mb-4 flex items-center justify-center p-4 bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 text-white shadow-2xl overflow-hidden animate-in fade-in-0 duration-1000">
