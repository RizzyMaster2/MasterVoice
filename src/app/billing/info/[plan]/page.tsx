...
export default function BillingInfoPageWrapper() {
      ...
      <MainHeader user={user} />
       <main className="flex-1 py-12 md:py-20">
            <div className="container mx-auto px-4">
                {isLoading ? <Skeleton className="h-96 w-full max-w-2xl mx-auto" /> : <BillingInfoPageContent user={user} />}
            </div>
       </main>
    </div>
  )
