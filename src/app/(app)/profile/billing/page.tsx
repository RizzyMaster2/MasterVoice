...
export default function BillingPage() {
  ...
  // For now, we assume the user is on the 'free' plan.
  // This can be replaced with actual user subscription data later.
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="p-4 bg-accent/50 rounded-lg flex items-start gap-3 text-accent-foreground">
            ...
            <p className="text-sm">Billing functionality is coming soon. This page is a preview of the subscription management options.</p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3 items-start">
            ...
            <Card key={tier.name} className={`flex flex-col h-full ${tier.featured ? 'border-primary ring-2 ring-primary' : ''} ${tier.id === currentUserPlanId ? 'bg-card/50' : 'bg-card'}`}>
                ...
                <Button 
                    ...
                    disabled={tier.disabled || tier.id === currentUserPlanId}
                >
                    {tier.link ? (
